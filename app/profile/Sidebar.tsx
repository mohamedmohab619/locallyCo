...
export default function Sidebar(){
   ...
   <div className="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      <ul className="pt-4 space-y-2 font-medium border-b border-gray-200 dark:border-gray-700">
      <li className="text-gray-900 dark:text-white">
         <div className="py-5">
         <h2>Hello!</h2>
         <p>user@email.com</p>
         <p>Your Profile is 20% complete</p>
         </div>
         <div className="w-full bg-gray-200 rounded-full h-2.5 mb-4 dark:bg-gray-700">
            <div className="bg-yellow-400 h-2.5 rounded-full w-15"></div>
         </div>
      </li>
      </ul>
      <ul className="pt-4 mt-4 space-y-2 font-medium">
         ...
         <li>
            <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
               ...
               <span className="flex-1 ms-3 whitespace-nowrap">LocallyCo credits</span>
               <span className="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
            </a>
         </li>
      </ul>
      <ul className="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
      <h2 className="flex-1 ms-3 whitespace-nowrap text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">My Account</h2>
      <li>
         <a href="#" className="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
