...
const Payment = () => {
  const styleDiv = "flex flex-col my-2 text-brown";
  const styleInput =
    "border-1 border-light-gray bg-white focus:border-brown rounded px-2 py-1 my-2 outline-0 text-dark-brown";
  const styleH3 = "text-lg font-bold my-3 text-dark-brown";
  const government = [
  ...
  return (
    <div className=" rounded p-3 bg-beige">
      <form>
        ...
        <div className="flex items-center gap-2">
          <input
            type="radio"
            name="paymentWay"
            className="accent-brown w-5 h-5"
            checked={true}
          />
