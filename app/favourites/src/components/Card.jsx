...
<div className="max-w-65 h-full bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 justify-self-center">
    ...
    <div className="px-5 pb-5">
        ...
        <div className="flex items-end justify-between flex-wrap">
            <span className="text-3xl font-bold text-gray-900 dark:text-white">599<span className="text-sm font-medium">EGP</span> </span>
            <div className="flex items-center">
                ...
                <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2.5 py-0.5 rounded-sm dark:bg-blue-200 dark:text-blue-800 ms-3">(120)</span>
            </div>
        </div>
    </div>
</div>
